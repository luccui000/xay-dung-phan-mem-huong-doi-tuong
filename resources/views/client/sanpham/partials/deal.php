<div class="row">
    <div class="col-lg-6 deal-col">
        <div class="deal" style="background-image: url('public/client/images/deal/bg-1.jpg');">
            <div class="deal-top">
    ...
    <div class="col-lg-6 deal-col">
        <div class="deal" style="background-image: url('public/client/images/deal/bg-2.jpg');">
            <div class="deal-top">
